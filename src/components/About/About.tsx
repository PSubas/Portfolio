...
const About: React.FC = () => {
  ...
  return (
    <section className={styles.about} id="about" data-scroll-section ref={sectionRef}>
        ...
        <div className={styles.right}>
            <div>
                ...
                <p className={styles.bio}>
                    ...
                    Merging technical mastery with artistic vision, I create websites that leave a lasting impression.
                </p>
            </div>

            <div className={styles.skillsGrid}>
                {skills.map((skill, index) => (
                    <div key={index} className={styles.skillCard} style={{ '--hover-color': skill.color } as React.CSSProperties}>
